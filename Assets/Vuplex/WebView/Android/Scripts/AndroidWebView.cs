...
namespace Vuplex.WebView {
    ...
    public class AndroidWebView : BaseWebView,
        ...
        /// <summary>
        /// An event that maps directly to the native <see href="https://developer.android.com/reference/android/webkit/WebViewClient#onReceivedClientCertRequest(android.webkit.WebView,%20android.webkit.ClientCertRequest)">>onReceivedClientCertRequest()</see>
        /// API for handling client certificate requests. The AndroidJavaObject in the EventArgs is the native <see href="https://developer.android.com/reference/android/webkit/ClientCertRequest">ClientCertRequest</see> object.
